...
trait SoftDelete
{
    ...
    public function restore()
    {
        ...
        $getOldDeletedAtAttribute = $this->getOldAttribute(static::$deletedAtAttribute);

        if (empty($getOldDeletedAtAttribute)) {
            $this->afterRestore();
            return true;
        }
    ...
    {
        $getOldDeletedAtAttribute = $this->getOldAttribute(static::$deletedAtAttribute);
        return ! empty($getOldDeletedAtAttribute);
    }
